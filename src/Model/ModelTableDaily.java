...
public class ModelTableDaily {


    public ModelTableDaily(String empId, String FName, String LName, String day, String type, String amArr, String amDep, String pmArr, String pmDep, String date) {
        this.EmpId = empId;
        this.FName = FName;
        this.LName = LName;
        this.Day = day;
